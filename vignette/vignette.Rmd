...
gridExtra::grid.arrange(grobs = g, ncol = 4)  # Ici, ncol spécifie 2 colonnes
```
...
```{r fig.height=10, fig.width=16, message=FALSE, warning=FALSE, paged.print=FALSE}
gridExtra::grid.arrange(grobs = g2, ncol = 4)  # Ici, ncol spécifie 2 colonnes
```



```{r fig.height=10, fig.width=16, message=FALSE, warning=FALSE, paged.print=FALSE }
gridExtra::grid.arrange(grobs = g3, ncol = 4)  # Ici, ncol spécifie 2 colonnes
```
...
library(pROC)
library(ggplot2)
tmp <- plotAUC_mc(best.model_ovo$score_, y, percent = TRUE, approch = "ovo"); rm(tmp)
# Create ROC objects for the training set
roc_objects_train <- lapply(best.model_ovo$score_, function(score) {
  roc(response = y, predictor = score)
})

# Create ROC objects for the test set
roc_objects_test <- lapply(best.model.test_ovo$score_, function(score) {
  roc(response = y.test, predictor = score)
})
...
```{r fig.height=12, fig.width=20, message=FALSE, warning=FALSE, paged.print=FALSE}
gridExtra::grid.arrange(grobs = g, ncol = 6)  # Ici, ncol spécifie 6 colonnes
...
```{r fig.height=12, fig.width=20, message=FALSE, warning=FALSE, paged.print=FALSE}
gridExtra::grid.arrange(grobs = g2, ncol = 6)  # Ici, ncol spécifie 6 colonnes
```


```{r fig.height=12, fig.width=20, message=FALSE, warning=FALSE, paged.print=FALSE}
gridExtra::grid.arrange(grobs = g3, ncol = 6)  # Ici, ncol spécifie 6 colonnes
```
