...
```{r}
Voting_Aggregation_FBM_ = Voting_Aggregation_FBM[[4]][[1]]
...
```{r}
pop = res_clf_ovo$classifier$models
Weighted_Aggregation_FBM <- evaluatePopulation_aggregation(pop = pop, y = y.test, X = X.test, force.re.evaluation = TRUE, clf,  aggregation = "weightedAggregation")
# Sauvegarder l'objet sous forme d'un fichier .rda
save(Weighted_Aggregation_FBM, file = "Weighted_Aggregation_FBM.rda")
```


```{r}
load("Weighted_Aggregation_FBM.rda")
```
...
data <- data.frame(
  Metric = rep(c("Accuracy", "Precision", "Recall", "F1"), each = 4),
  Value = c(
    extract_metric_values(Weighted_Aggregation_FBM, "accuracy_") * 100,
    extract_metric_values(Weighted_Aggregation_FBM, "precision_") * 100,
    extract_metric_values(Weighted_Aggregation_FBM, "recall_") * 100,
    extract_metric_values(Weighted_Aggregation_FBM, "f1_") * 100
  ),
  Method = rep(c("K_2", "K_3", "K_4", "K_5"), times = 4)
)
...
```{r}
Weighted_Aggregation_FBM_ = Weighted_Aggregation_FBM[[4]][[1]]
...
NewApproach_Aggregation_FBM <- evaluatePopulation_aggregation(pop = pop, y = y.test, X = X.test, force.re.evaluation = TRUE, clf,  aggregation = "NewApproach")
# Sauvegarder l'objet sous forme d'un fichier .rda
save(NewApproach_Aggregation_FBM, file = "NewApproach_Aggregation_FBM.rda")
```



```{r}
load("NewApproach_Aggregation_FBM.rda")
```
...
data <- data.frame(
  Metric = rep(c("Accuracy", "Precision", "Recall", "F1"), each = 4),
  Value = c(
    extract_metric_values(NewApproach_Aggregation_FBM, "accuracy_") * 100,
    extract_metric_values(NewApproach_Aggregation_FBM, "precision_") * 100,
    extract_metric_values(NewApproach_Aggregation_FBM, "recall_") * 100,
    extract_metric_values(NewApproach_Aggregation_FBM, "f1_") * 100
  ),
  Method = rep(c("K_2", "K_3", "K_4", "K_5"), times = 4)
)
...
```{r}
NewApproach_Aggregation_FBM_ = NewApproach_Aggregation_FBM[[4]][[1]]
...
```{r}
pop = res_clf_ova$classifier$models
Maximization_Aggregation_FBM <- evaluatePopulation_aggregation(pop = pop, y = y.test, X = X.test, force.re.evaluation = TRUE, clf,  aggregation = "maximizationAggregation")
# Sauvegarder l'objet sous forme d'un fichier .rda
save(Maximization_Aggregation_FBM, file = "Maximization_Aggregation_FBM.rda")
```


```{r}
load("Maximization_Aggregation_FBM.rda")
```
...
data <- data.frame(
  Metric = rep(c("Accuracy", "Precision", "Recall", "F1"), each = 4),
  Value = c(
    extract_metric_values(Maximization_Aggregation_FBM, "accuracy_") * 100,
    extract_metric_values(Maximization_Aggregation_FBM, "precision_") * 100,
    extract_metric_values(Maximization_Aggregation_FBM, "recall_") * 100,
    extract_metric_values(Maximization_Aggregation_FBM, "f1_") * 100
  ),
  Method = rep(c("K_2", "K_3", "K_4", "K_5"), times = 4)
)
...
```{r}
Maximization_Aggregation_FBM_ = Maximization_Aggregation_FBM[[4]][[1]]
...
```{r warning=FALSE}
pop = res_clf_ova$classifier$models
Ranking_Aggregation_FBM <- evaluatePopulation_aggregation(pop = pop, y = y.test, X = X.test, force.re.evaluation = TRUE, clf,  aggregation = "rankingAggregation")
# Sauvegarder l'objet sous forme d'un fichier .rda
...
data <- data.frame(
  Metric = rep(c("Accuracy", "Precision", "Recall", "F1"), each = 4),
  Value = c(
    extract_metric_values(Ranking_Aggregation_FBM, "accuracy_") * 100,
    extract_metric_values(Ranking_Aggregation_FBM, "precision_") * 100,
    extract_metric_values(Ranking_Aggregation_FBM, "recall_") * 100,
    extract_metric_values(Ranking_Aggregation_FBM, "f1_") * 100
  ),
  Method = rep(c("K_2", "K_3", "K_4", "K_5"), times = 4)
)
...
```{r}
Ranking_Aggregation_FBM_ = Ranking_Aggregation_FBM[[4]][[1]]
