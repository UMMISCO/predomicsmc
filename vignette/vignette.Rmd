...
set.seed(42)
indices_division <- createDataPartition(y_equilibre, p = 0.98, list = FALSE)
...
if(runit)
{
  res_clf <- fit_mc(X = X.test, y = y.test, clf = clf,approch="ovo", cross.validate = TRUE, nfolds = 1); # class(res_clf)
  # save results
...
```{r}
# voici les résultats de mon modele avec one versus one
print(mod)
#voici les différentes combinaison de l'approche one versus one
print(list_y)
```
