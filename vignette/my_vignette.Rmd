...
```{r warning=FALSE, paged.print=FALSE, message=FALSE,fig.height=12, fig.width=13}
...
pdf("model_visualization_plots2.pdf", width = 15, height = 15)  # Adjust width and height as needed
