...
if(runit)
{
res_clf_mc <- fit_mc(X = X, y = y, clf = clf,approch="ova", cross.validate = TRUE,aggregation_ = "Predomics_aggregation_ovo", nfolds= 10, constrained = FALSE); 
...
```{r warning=FALSE, paged.print=FALSE, message=FALSE,fig.height=35, fig.width=70}
