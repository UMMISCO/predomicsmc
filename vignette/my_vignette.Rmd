...
pop <- modelCollectionToPopulation(weighted_f1_auc_terbeam_unconstrained$classifier$models)
printy_mc(pop)
...
```{r warning=FALSE, paged.print=FALSE, message=FALSE,fig.height=13, fig.width=15}
...
```{r warning=FALSE, paged.print=FALSE, message=FALSE,fig.height=12, fig.width=12}
  feat1.import <- mergeMeltImportanceCV_mc(list.results = list(terBeam = weighted_f1_auc_terbeam_unconstrained ),
                                        filter.cv.prev = 0,
                                        min.kfold.nb = FALSE,
  ...
  feat2.import <- mergeMeltImportanceCV_mc(list.results = list(terBeam = weighted_f1_auc_terbeam_unconstrained),
                                        filter.cv.prev = 0,
                                        min.kfold.nb = FALSE,
                                        learner.grep.pattern = "*",
                                        nb.top.features = 148,
