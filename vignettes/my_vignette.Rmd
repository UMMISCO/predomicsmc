...
```{r}
##clf <- terBeam_mc(sparsity = c(4,5,6,7,8,9,10), 
...
##if(runit)
##{
##res_clf_mc_enterotype_Majority_Voting_With_Tie_Breaking_ovo <- fit_mc(X = X, y = y, clf = clf,approch="ovo", cross.validate = TRUE,aggregation_ = "Majority_Voting_with_Tie_Breaking", nfolds = 10, constraint_factor = "semi_constrained"); 
##save(res_clf_mc_enterotype , clf, file ="res_clf_mc_enterotype.rda", compression_level = 9)
##}
...
##data("Analysis_Dataset_Complet_Sota_Predo", package = "mcpredomics")
##pop <- modelCollectionToPopulation(Analysis_Dataset_Complet_Sota_Predo$classifier$models)
##printy_mc(pop)
...
```{r warning=FALSE, paged.print=FALSE, message=FALSE,fig.height=8, fig.width=43}
  ...
  ##feat1.import <- mergeMeltImportanceCV_mc(list.results = list(terBeam =  Analysis_Dataset_Complet_Sota_Predo),
                                        ##filter.cv.prev = 0,
                                        ##min.kfold.nb = FALSE,
  ...
  ##feat2.import <- mergeMeltImportanceCV_mc(list.results = list(terBeam = Analysis_Dataset_Complet_Sota_Predo),
                                       ## filter.cv.prev = 0,
                                        ##min.kfold.nb = FALSE,
                                        ##learner.grep.pattern = "*",
                                       ## nb.top.features = 148,
